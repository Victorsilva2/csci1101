...
while game_running_flag:
    ...
    if 0 <= game_characteristics["player"]["position"]["x"] + position_delta["player"]["position"]["x"] + position_delta +game_tank_sprite.get_width() <= game_characteristics["cpu"]["position"]["x"]:
    ...
    game_tank_sprite_cpu = pygame.transfor.flip(game_tank_sprite, True, False)

    game_display.blit(game_tank_sprite_cpu, (game_characteristics["cpu"]["position"]["x"], game_characteristics["grass"]["posiiton"]["y"] -game_tank_sprite_cpu.get.get_height()))
